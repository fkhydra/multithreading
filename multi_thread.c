...
HANDLE THANDLER_1;
bool vege = false,fejezd_be=false;

LRESULT CALLBACK WndProc0(HWND, UINT, WPARAM, LPARAM);
void D2D_rajzolas(void* pParams);
...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
 ...
 case WM_CREATE:
  ...
  THANDLER_1 = (HANDLE)_beginthread(szal_1, 0, NULL);
  return 0;
 //*********************************
